...
PRODUCT = {
    ...
    "ingredients": [
        {"name": "麦角硫因", "narrative": "抗氧化，承接熬夜后暗沉修护叙事"},
        {"name": "虾青素", "narrative": "抗氧化，承接熬夜后暗沉修护叙事"},
        {"name": "肌肽 / 脱羧肌肽", "narrative": "抗糖化科普叙事"},
        {"name": "烟酰胺", "narrative": "提亮"},
        {"name": "泛醇（维生素B5）", "narrative": "保湿"},
        {"name": "依克多因", "narrative": "舒缓修护"},
    ],
}
